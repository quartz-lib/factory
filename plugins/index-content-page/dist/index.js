...
function q(n2, u3, t2, i2, r2, o2, e2, f3, c2, a2) {
  ...
  n: if ("function" == typeof T2) try {
    ...
    if (h2.context = $2, h2.props = k2, h2.__P = n2, h2.__e = false, I2 = l.__r, P2 = 0, x2) h2.state = h2.__s, h2.__d = false, I2 && I2(u3), s2 = h2.render(h2.props, h2.state, h2.context), w.push.apply(h2.__h, h2._sb), h2._sb = [];
    else do {
      h2.__d = false, I2 && I2(u3), s2 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s;
    } while (h2.__d && ++P2 < 25);
    h2.state = h2.__s, null != h2.getChildContext && (i2 = m(m({}, i2), h2.getChildContext())), x2 && !p2 && null != h2.getSnapshotBeforeUpdate && (d2 = h2.getSnapshotBeforeUpdate(v2, y2)), A2 = null != s2 && s2.type === S && null == s2.key ? E(s2.props.children) : s2, f3 = L(n2, g(A2) ? A2 : [A2], u3, t2, i2, r2, o2, e2, f3, c2, a2), h2.base = u3.__e, u3.__u &= -161, h2.__h.length && e2.push(h2), _2 && (h2.__E = h2.__ = null);
  } catch (n3) {
...
var IndexContentPage = () => ({
  ...
  generate({ content }) {
    ...
    for (const file of allFiles) {
      ...
      if (!slug) continue;
      for (const f3 of getFolders(slug).filter((folder) => folder !== "." && folder !== "tags")) {
        folders.add(f3);
      }
      const relativePath = file?.relativePath;
      if (!relativePath) continue;
      const slugParts = dirname(slug).split("/").filter((s2) => s2 !== ".");
      const pathParts = dirname(relativePath).split("/").filter((s2) => s2 !== ".");
...
export {
  ContentBody_default as ContentBody,
  IndexContentPage
};
